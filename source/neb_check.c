...
{ 
  ...
  s_vec[i]="OptC8";                   i_vec[i]=35; i++; /* cell opt with fixed direction of lattice vectors by SD */
  s_vec[i]="RFC8";                    i_vec[i]=36; i++; /* cell opt with fixed direction of lattice vectors by RF */
